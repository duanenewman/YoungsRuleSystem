using Amendment.Server.IdentityStores;
using Amendment.Server.Data;
...
builder.Services.AddScoped<IPasswordHasher<User>, Amendment.Server.IdentityStores.PasswordHasher<User>>();
